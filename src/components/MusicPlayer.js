...
export const MusicPlayer = () => {
  ...
  return (
    <section className="music-player" style={{ padding: '20px 0', backgroundColor: '#222e5d;' }}>
      ...
      {isPlayerVisible && (
        <Row className="align-items-start" style={{ backgroundColor: '#222e5d;', borderRadius: '8px', padding: '20px' }}>
          {/* Playlist Section */}
